...
def identify_k(b, d, N):
    """
    This function identifies the intrinsic frequency component k with given parameters.
    Args:
    ...
    # Identify the intrinsic frequency component according to Eq.(7)
